  ...
  return (
    ...
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://logos-world.net/wp-content/uploads/2020/05/LG-Logo-2014-present.png"
            style={{width:"150px", objectFit:"contain"}}
            alt=""
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://th.bing.com/th/id/OIP.5Wnab1rqiO5R32fAh32N9AHaEK?rs=1&pid=ImgDetMain"
            style={{width:"150px", objectFit:"contain"}}
            alt=""
          />
        </div>
